...
//   return (
//     <div>
//       <h2 className="text-4xl font-semibold font-Cinzel text-center my-16 ">View All Study Sessions</h2>
...
//                   <td><Link to={'/dashboard/addMaterials'} state={session}> <button className="px-4 py-3 rounded-lg border ml-16 my-2 hover:bg-green-300 border-green-300">Upload Material</button> </Link></td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
